...
Функция ПолучитьНастройкуУстановки() Экспорт
	...
	Настройка.Вставить("СоздаватьФайлЗапуска", Истина);
...
Процедура УстановитьПакетИзОблака(Знач ИмяПакета, Знач РежимУстановки, Знач ЦелевойКаталог, Знач НастройкаУстановки = Неопределено) Экспорт
	...
	УстановкаПакета.УстанавливатьЗависимости(НастройкаУстановки.УстанавливатьЗависимости);
	УстановкаПакета.СоздаватьФайлЗапуска(НастройкаУстановки.СоздаватьФайлЗапуска);
